...
conf.set('spark.hadoop.fs.s3a.access.key', 'AKIA3PU7RNERXMILYKGU')    #AWS Access Key
conf.set('spark.hadoop.fs.s3a.secret.key', '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')   #AWS Secret Key
